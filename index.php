...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center mb-md-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="home_product.php">Product</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="border-bottom">
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="display-4 fw-normal">EeeGame Store</h1>
    ...
    <div class="container pt-4 pb-4 border-bottom">
        <h2 class="text-center text-decoration-underline">Product</h2>
        <div class="row row-cols-1 row-cols-md-3 g-4 my-3 px-3">
            <?php
            include "database/koneksi.php   ";
            $sql = "SELECT * FROM tbl_produk LIMIT 6";
            $no = 1;
        ...
        <a href="home_Product.php" class="nav-link">
